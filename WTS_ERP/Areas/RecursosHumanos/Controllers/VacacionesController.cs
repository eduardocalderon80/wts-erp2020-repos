...
namespace WTS_ERP.Areas.RecursosHumanos.Controllers
{
    ...
    {
        // GET: RecursosHumanos/Vacaciones        
        ...
        // GET: Redireccionar
        public ActionResult IrVacaciones()
        {
            ...
            redirection.Controlador = "Vacaciones";
            redirection.Vista = "Index";
            redirection.Accion = "view";
        ...
        // GET: Redireccionar
        public ActionResult ConfirmarVacaciones(string id)
        {
            // Base64 parameter to string
        ...
        [HttpGet]
        [AccessSecurity]
        public string GetAllData_Vacaciones()
        {
            blMantenimiento oMantenimiento = new blMantenimiento();
            string par = _.Get("par");
            par = _.addParameter(par, "idusuario", _.GetUsuario().IdUsuario.ToString());
            ...
            string data = oMantenimiento.get_Data("GestionTalento.usp_GetAll_Vacaciones", par, true, Util.ERP);
            return data != null ? data : string.Empty;
        }
        ...
        public string GetAllData_FechasFuturas()
        {
            ...
            string data = oMantenimiento.get_Data("GestionTalento.usp_Get_Totalvacaciones", par, true, Util.ERP);
            return data != null ? data : string.Empty;
        }

        [HttpPost]
        [AccessSecurity]
        public string InsertData_Vacaciones()
        {
            blMantenimiento oMantenimiento = new blMantenimiento();
            string par = _.Post("par");
            par = _.addParameter(par, "usuario", _.GetUsuario().Usuario);
            ...
            string data = oMantenimiento.get_Data("GestionTalento.usp_Insert_Vacaciones", par, false, Util.ERP);
            return data != null ? data : string.Empty;
        }

        [HttpPost]
        [AccessSecurity]
        public string UpdateData_Vacaciones()
        {
            blMantenimiento oMantenimiento = new blMantenimiento();
            string par = _.Post("par");
            par = _.addParameter(par, "usuario", _.GetUsuario().Usuario);
            par = _.addParameter(par, "idusuario", Convert.ToString(_.GetUsuario().IdUsuario));
            string data = oMantenimiento.get_Data("GestionTalento.usp_Update_Vacaciones", par, false, Util.ERP);
            return data != null ? data : string.Empty;
        }
    }
}