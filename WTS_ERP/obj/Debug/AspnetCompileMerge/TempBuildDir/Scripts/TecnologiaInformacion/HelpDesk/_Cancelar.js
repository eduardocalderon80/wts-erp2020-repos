var app_Ticket_Cancelar = (
    function (d, idpadre) {
        ...
        function load() {
            let par = _('txtpar_ticket_cancelar').value;
            if (!_isEmpty(par)) {
            ...
            _('btn_guardar_cancelar').addEventListener('click', req_guardar);
        }
        ...
        function req_guardar() {
            let requerido = required_item_class({ id: 'pnl_ticket_cancelar', clase: '_enty' });
        ...
        function fn_guardar() {
            ...
            let oticket = _getParameter({ id: 'pnl_ticket_cancelar', clase: '_enty' });
            form = new FormData();
...
)(document, 'pnl_ticket_cancelar');

(function ini() {
    app_Ticket_Cancelar.load();
})();