var app_Ticket_Detener = (
    function (d, idpadre) {
        ...
        function load() {
            let par = _('txtpar_ticket_detener').value;
            if (!_isEmpty(par)) {
            ...
            _('btn_guardar_detener').addEventListener('click', req_guardar);
        }
        ...
        function req_guardar() {
            let requerido = required_item_class({ id: 'pnl_ticket_detener', clase: '_enty' });
        ...
        function fn_guardar() {
            ...
            let oticket = _getParameter({ id: 'pnl_ticket_detener', clase: '_enty' });
            form = new FormData();
