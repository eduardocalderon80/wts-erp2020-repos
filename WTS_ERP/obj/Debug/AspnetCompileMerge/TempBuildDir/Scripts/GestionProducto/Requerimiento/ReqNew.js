var app_Requerimiento_New = (
     ...
     function (d, idpadre) {
         ...
         function fn_load_analista() {
             ...
             ovariables.arr_id_analista_selection = ovariables.arr_analista;
             _('cbo_analista').innerHTML = cbo_analista;
             $('#cbo_analista').select2();
         }
...
)(document, 'pnl_requerimiento_new');

(function ini() {
    app_Requerimiento_New.load();
    app_Requerimiento_New.req_ini();
})();
