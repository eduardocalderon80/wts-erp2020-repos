    ...
    function (d, idpadre) {
        ...
        function req_ini() {
            let err = function (__err) { console.log('err', __err) },
                parametro = { x: 1 };
            _Get('RecursosHumanos/Licencias/GetAllData_Licencias?par=' + JSON.stringify(parametro))
                .then((resultado) => {
                ...
                data.forEach(x => {
                    htmlbody += `<tr>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <button class="btn btn-sm btn-outline btn-primary" onclick="appLicenciasIndex.fn_edit(${x.idsolicitud})">
                                    ...
                                    <td class='text-center'>${fn_calculardias(x.fechainicio, x.fechafin)}</td>
        ...
        function fn_calculardias(fechainicio, fechafin) {
            let date1 = _strToDate(fechainicio + ' 0:00');
            let date2 = _strToDate(fechafin + ' 0:00');
        ...
        function fn_crearbarchart(_json, esjefe, lstsolicfilter) {
            ...
            if (esjefe === 1) {
                ...
                _("h5-ibox-graficobar").innerText = "Días de Licencias por Año (" + date_year +")";
            }
            const date_year = new Date().getFullYear();
        ...
        function fn_ReporteSolicitud(_json) {
                ...
                data.forEach(x => {
                    if (aux === 0) {
                        ...
                        html += `<tr>
                                    ...
                                    <td valign="vertical" align="center" style="background: #ffffff;">${x.fechafin}</td>
                                    <td valign="vertical" align="center" style="background: #ffffff;">${fn_calculardias(x.fechainicio, x.fechafin)}</td>
                        ...
                        html += `<tr>
                                    ...
                                    <td valign="vertical" align="center" style="background: #d9d9d9;">${x.fechafin}</td>
                                    <td valign="vertical" align="center" style="background: #d9d9d9;">${fn_calculardias(x.fechainicio, x.fechafin)}</td>
            ...
            _createExcel({
                worksheet: 'Reporte Licencias',
                style: '',
                table: html,
                filename: 'Reporte Licencias'
            });
        }
        ...
        function fn_new() {
            let urlAccion = 'RecursosHumanos/Licencias/New';
...
)(document, 'panelEncabezado_LicenciasIndex');
(
    function ini() {
        appLicenciasIndex.load();
        appLicenciasIndex.req_ini();
    }
)();