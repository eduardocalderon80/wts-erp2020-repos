var app_Destino_View = (
    function (d, idpadre) {
        ...
        //        let html =
        //            `<tr data-par='iddestino:${x.iddestino},iddestinodireccion:0,idruta:${odireccion.idruta},iddistrito:${odireccion.iddistrito}'>
        ...
        //            swal({ title: "Buen Trabajo!", text: "Usted ha registrado un nuevo destino correctamente", type: "success" });
        //            fn_return();
        //        };
...
)(document, 'pnl_destino_view');

(function ini() {
    app_Destino_View.load();
    app_Destino_View.req_ini();
})();