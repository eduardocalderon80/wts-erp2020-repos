...
function ConfirmarPassword() {
    ...
    if (txt.trim().length > 0 && opar.par !== '' && comentario.trim().length > 0) {
        ...
        Post('TecnologiaInformacion/TicketConfirmacion/Ticket_Validar_Rechazar', frm, exitoAprobacion)
    } else {
        var amensaje = [];
...
(function () {
    ...
    document.getElementById('tituloapp').innerHTML = 'Rechazar Ticket: # ' + opar.numero;
