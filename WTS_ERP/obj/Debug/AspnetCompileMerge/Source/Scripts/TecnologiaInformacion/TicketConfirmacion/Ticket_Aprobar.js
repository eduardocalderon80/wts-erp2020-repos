...
function ConfirmarPassword() {
    ...
    if (txt.trim().length > 0 && opar.par !== '') {
        ...
        Post('TecnologiaInformacion/TicketConfirmacion/Ticket_Validar_Aprobar', frm, exitoAprobacion)
    } else {
        swal({
            title: 'Error!',
...
(function () {
    ...
    document.getElementById('tituloapp').innerHTML = 'Aprobar Ticket: # ' + opar.numero;
})();