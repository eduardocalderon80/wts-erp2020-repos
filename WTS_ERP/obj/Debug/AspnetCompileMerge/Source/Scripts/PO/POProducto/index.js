...
function ejecutarbuscarpo() {
    ...
    let combocliente = _('cboCliente'),
        ...
        parametro = JSON.stringify({
            ...
            //idusuario: 0,
            idempresa: 3,  // :edu 20171031 DATO HARDCODEADO LUEGO CAMBIAR CUANDO FUNCIONE SEGURIDAD
            idgrupopersonal: 8,
    ...
    Get('PO/POProducto/getData_byParamaters?par=' + parametro, mostrardata);
}
...
function ejecutarnewpo() {
    let urlaccion = 'PO/POProducto/addPOProducto',
        urljs = 'PO/POProducto/addPOProducto';
...
function savepotopdf(idpo, idpocliente) {
    urlaccion = ovariables.urlbase + `PO/POProducto/SavePoToPdf?pidpo=${idpo}&pidpocliente=${idpocliente}`;
