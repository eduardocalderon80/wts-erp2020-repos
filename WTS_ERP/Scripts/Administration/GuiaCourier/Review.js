...
function load() {
    ...
    _('btnlimpiar').addEventListener('click', fn_new);
...
function req_add() {
    ...
    if (req || req2) {
        let urlaccion = 'Administration/GuiaCourier/GuiaCourier_Valid';
        let guia = _('txtnumeroguia').value;
        let par = _par('guia', guia);
        form = new FormData();
        form.append()
    }
    else {
...
function fn_executemodal() {
    ...
    let urlaccion = 'Administration/GuiaCourier/Valid';
