var app_Solicitud_Textil_New = (
    function (d, idpadre) {
        ...
        function load() {
            ...
            fn_load_div_collapse('pnl_solicitud_textil_new');
        ...
        function fn_save() {
            clean_required_item();
            let req_principal, req_detalle, req_sub_detalle = true, req_asistente = 1;

            req_principal = required_item({ id: 'pnl_courier_service_principal', clase: '_enty' });

            if (req_principal) {

                if (ovariables.idservicio == 1) { req_detalle = required_item({ id: 'pnl_courier_service_courier', clase: '_enty' }); }
                else {
                    req_detalle = required_item({ id: 'pnl_courier_service_reunion', clase: '_enty' });
        ...
        function req_insert_reunion() {
            ...
            if (ovariables.idviewretorno == 1) { oretorno = JSON.stringify(_getParameter({ id: 'div_retorno', clase: '_enty_aditional' })); }
                ...
                if (orpta.estado === 'success') {
                    ...
                    if (ovariables.idtiposervicio == '1') {
                        swal({
                            ...
                            swal({ title: "Atención!", text: "Debe recordar que todo envio solo saldrá de WTS con un Cargo", type: "success" });
                            fn_return();
                        });
                    }
                    else {
        ...
        function fn_load_turno(_iditem) {
            ...
            let resultado = ovariables_data.arr_dias_total.filter(x=>x.fecha.toString() === fecha && x.estado === 'Open');
        ...
        function req_change_turno(e) {
            ...
            if (ovariables.idservicio == 1) { iditem = 'cbo_courier_hora'; }
            else if (ovariables.idservicio == 2) {
        ...
        function req_change_vehiculo(e) {
            ...
            if (ovariables.idservicio == 1) { iditem = 'cbo_courier_destino'; }
                ...
                iditem = 'cbo_reunion_salida_destino_fin';
            }
        ...
        function req_change_destino(e) {
            ...
            else if (ovariables.idservicio == 2) { idmain = 'cbo_reunion_salida_vehiculo'; iditem = 'cbo_reunion_salida_direccion_fin'; }
...
)(document, 'pnl_solicitud_textil_new');

(function ini() {
    app_Solicitud_Textil_New.load();
    app_Solicitud_Textil_New.req_ini();
})();