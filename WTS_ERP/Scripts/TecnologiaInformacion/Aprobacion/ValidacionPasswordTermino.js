...
function ConfirmarPassword() {
    ...
    if (txt.trim().length > 0 && opar.par !== '') {
        ...
        Post('TecnologiaInformacion/Aprobacion/validarCredencialesAprobacionTermino', frm, exitoAprobacion)
    } else {
        swal({
            title: 'Error!',
...
(function () {
    ...
    document.getElementById('tituloapp').innerHTML = 'Terminar: #' + opar.id;
